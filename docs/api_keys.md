...
The Weather plugin requires API credentials when using OpenWeatherMap. These credentials must be stored in a .env file located at the root of the project. Once you have your API token, follow these steps:
